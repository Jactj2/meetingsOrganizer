...
@NonNullApi
public class MeetingWorkbooksOrganizerProjectDependency extends DelegatingProjectDependency {

    @Inject
    public MeetingWorkbooksOrganizerProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
