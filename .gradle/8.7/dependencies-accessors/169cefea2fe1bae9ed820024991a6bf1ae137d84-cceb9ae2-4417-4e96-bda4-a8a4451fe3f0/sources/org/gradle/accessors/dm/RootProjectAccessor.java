...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public MeetingWorkbooksOrganizerProjectDependency getMeetingWorkbooksOrganizer() { return new MeetingWorkbooksOrganizerProjectDependency(getFactory(), create(":")); }
